...
set terminal postscript color "CharterBT-Roman" 11 enhanced size 7,7
...
xmax = 0.15
set xrange[xmin:xmax]
set xtics 0.05,0.01,0.148
set mxtics
#set format x "10^{%T}"
set label 2 "sin^{2}2{/Symbol q}_{13}" at 0.1,-0.0074 center

## y-axis settings
#set logscale y
set ytics offset -48.0
set ytics -0.005,0.002,0.005
set mytics
ymin = -6e-3
ymax = +6e-3
set yrange[ymin:ymax]
set label 4 "{/Symbol e}" at 0.036,0.0 center rotate by 90

## Mark at the BF
set label 35 "+" at 0.0944444, 0.00111111 center font "CharterBT-Roman,15"
## Minimum chi2 value
min = 2.07188

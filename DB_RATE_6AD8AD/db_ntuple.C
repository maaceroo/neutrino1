...
// For the data analysis, using information from:                      //
...
{ // begin
    ...
    int Nevents = 1000000;
        for (int i = 0 ; i < Nevents ; i++)
        {
            ...
            //if (id is 0 or 1, EH1 spectum; id is 2 or 3, EH2 spectum; id is 4 to 7, EH3 spectum) this is for Ep
            if      (id < 2)           ad = 0;
            else if (id > 1 && id < 4) ad = 1;
            else if (id > 3 && id < 8) ad = 2;

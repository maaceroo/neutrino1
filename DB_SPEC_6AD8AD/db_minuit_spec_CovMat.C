...
// Information obtained by executing the script "db_osc_spec.C", printed to a txt file
...
//IBD rate per day w/o oscillations
double noOsc_IBDrate_perday_6AD[nAD]//; = {663.15,673.95,591.86,78.75,78.46,77.58}; //-- Modified by the macro "db_osc_spec.C"
//---*****************************************************---//
//---*****************************************************---//
//-- Information for 8AD

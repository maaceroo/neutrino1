...
void MINOS_spectra(){
  ...
  minos110_numubar_WS_data  = new TGraph("data/PRL110_numu_FD_Data_numubar_WS.csv","%lg,%lg","");
  minos110_numubar_WS_bkgd  = new TGraph("data/PRL110_numu_FD_NCBkgd_numubar_WS.csv","%lg,%lg","");
  minos110_numubar_WS_BF    = new TGraph("data/PRL110_numu_FD_BF_numubar_WS.csv","%lg,%lg","");
  minos110_numubar_WS_noosc = new TGraph("data/PRL110_numu_FD_NoOscPred_numubar_WS.csv","%lg,%lg","");
  ...
  // define binning for Muon Antineutrinos (WS) PRL110
  ...
  TH1F *numubWS110_dataPerGeV_histo = new TH1F("numubWS110_dataPerGeV_histo" ,"",NB_numubarWS110,xbins_nubWS110);
  TH1F *numubWS110_data_histo  = new TH1F("numubWS110_data_histo" ,"",NB_numubarWS110,xbins_nubWS110);
  numubWS110_dataPerGeV_histo->SetLineWidth(2);
  ...
  TH1F *numubWS110_bkgdPerGeV_histo = new TH1F("numubWS110_bkgdPerGeV_histo" ,"",NB_numubarWS110,xbins_nubWS110);
  TH1F *numubWS110_bkgd_histo  = new TH1F("numubWS110_bkgd_histo" ,"",NB_numubarWS110,xbins_nubWS110);
  numubWS110_bkgdPerGeV_histo->SetLineWidth(1);
  numubWS110_bkgdPerGeV_histo->SetLineColor(kBlack);
  numubWS110_bkgdPerGeV_histo->SetFillColor(kGray);
  TH1F *numubWS110_bfitPerGeV_histo = new TH1F("numubWS110_bfitPerGeV_histo" ,"",NB_numubarWS110,xbins_nubWS110);
  TH1F *numubWS110_bfit_histo  = new TH1F("numubWS110_bfit_histo" ,"",NB_numubarWS110,xbins_nubWS110);;
  numubWS110_bfitPerGeV_histo->SetLineWidth(2);
  numubWS110_bfitPerGeV_histo->SetLineColor(kBlue);
  ...
  for (int j = 0 ; j < NB_numubarWS110 ; j++)
    {
      ...
      numubWS110_dataPerGeV_histo->SetBinContent(j+1,ctnt);
      width = numubWS110_dataPerGeV_histo->GetBinWidth(j+1);
      numubWS110_data_histo->SetBinContent(j+1,ctnt*width);
      //NoOsc ------------------//
      ctnt = minos110_numubar_WS_noosc->GetY()[j];
      numubWS110_nooscPerGeV_histo->SetBinContent(j+1,ctnt);
      numubWS110_noosc_histo->SetBinContent(j+1,ctnt*width);
      //Bkgd _------------------//
      ctnt = minos110_numubar_WS_bkgd->GetY()[j];
      numubWS110_bkgdPerGeV_histo->SetBinContent(j+1,ctnt);
      numubWS110_bkgd_histo->SetBinContent(j+1,ctnt*width);
      //BFit _------------------//
      ctnt = minos110_numubar_WS_BF->GetY()[j];
      numubWS110_bfitPerGeV_histo->SetBinContent(j+1,ctnt);
      numubWS110_bfit_histo->SetBinContent(j+1,ctnt*width);
    }
  //---------------------------------
  ...
  //- Frame for Muon antineutrinos (WS) PRL110
  TH2F *frame_spectra_numubWS = new TH2F("frame_spectra_numubWS","",NB_numubarWS110,0,hibWS110,10,0,34.0);
  frame_spectra_numubWS->GetXaxis()->SetTitle("Reconstructed Energy (GeV)");
  frame_spectra_numubWS->GetXaxis()->SetTitleFont(ft);
  frame_spectra_numubWS->GetXaxis()->SetTitleOffset(1.15);
  frame_spectra_numubWS->GetXaxis()->CenterTitle();
  frame_spectra_numubWS->GetXaxis()->SetTitleSize(1.0*sz);
  frame_spectra_numubWS->GetXaxis()->SetLabelSize(0.9*sz);
  frame_spectra_numubWS->GetXaxis()->SetLabelFont(ft);
  frame_spectra_numubWS->GetYaxis()->SetTitle("Events/GeV");
  frame_spectra_numubWS->GetYaxis()->SetTitleFont(ft);
  frame_spectra_numubWS->GetYaxis()->SetTitleOffset(1.1);
  frame_spectra_numubWS->GetYaxis()->CenterTitle();
  frame_spectra_numubWS->GetYaxis()->SetTitleSize(1.0*sz);
  frame_spectra_numubWS->GetYaxis()->SetLabelSize(0.9*sz);
  frame_spectra_numubWS->GetYaxis()->SetLabelFont(ft);
 ...
 */
  ...
  numubWS110_data_histo->Write();
  numubWS110_bfit_histo->Write();
  numubWS110_noosc_histo->Write();
  numubWS110_bkgd_histo->Write();
  numubWS110_dataPerGeV_histo->Write();
  numubWS110_bfitPerGeV_histo->Write();
  numubWS110_nooscPerGeV_histo->Write();
  numubWS110_bkgdPerGeV_histo->Write();

...
int main(int argc, char* argv[])
{
    ...
    string path1 = argv[3];
    string chi_file = "/data/numubWS_chi2_s2t-dm2_surface-noFL.txt";
    string min_chi = "/data/numubWS_chi2_minumum.txt";
    ...
    string s2t_file = "/data/numubWS_s2t_chi2.txt";
    string dmn_file = "/data/numubWS_dm2_chi2.txt";

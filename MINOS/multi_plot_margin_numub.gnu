...
########################################################################################
## Figure File
set output "2266612/files_plots/MINOS_plots_numub.pdf"
########################################################################################
...
plot '2266612/data/numub_dm2_chi2.txt' u 2:(10**3*($1)) w l lw 2
...
plot '2266612/data/numub_s2t_chi2.txt' u 1:2 w l lw 2 t "", 16.0 lt 6 lw 2 t "99.99% C.L. (4{/Symbol s})", 9.0 lt 2 lw 2 t "99.73% C.L. (3{/Symbol s})", 4.0 lt 3 lw 2 t "95.45% C.L. (2{/Symbol s})", 2.71 lt 5 lw 2 t "90.00% C.L.", 1.0 lt 4 lw 2 t "68.27% C.L. (1{/Symbol s})"
...
## Mark at the BF
set label 35 '+' at 0.9620250000,0.0024970000*1e3 center font 'CharterBT-Roman,15'
## Minimum chi2 value
min = 13.0885000000
...
splot '2266612/data/numub_chi2_s2t-dm2_surface-noFL.txt' u 1:(10**3*($2)):(($3)-min) w l lw 2

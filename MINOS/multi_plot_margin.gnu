...
plot 'data/numu_dm2_chi2.txt' u 2:(10**3*($1)) w l lw 2
...
plot 'data/numu_s2t_chi2.txt' u 1:2 w l lw 2 t "", \
...
splot 'data/numu_chi2_s2t-dm2_surface-noFL.txt' u 1:(10**3*($2)):(($3)-min) w l lw 2

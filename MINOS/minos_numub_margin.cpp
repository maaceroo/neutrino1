...
int main(int argc, char* argv[])
{
    ...
    string path1 = argv[3];
    string chi_file = "/data/numub_chi2_s2t-dm2_surface-noFL.txt";
    string min_chi = "/data/numub_chi2_minumum.txt";
    ...
    string s2t_file = "/data/numub_s2t_chi2.txt";
    string dmn_file = "/data/numub_dm2_chi2.txt";

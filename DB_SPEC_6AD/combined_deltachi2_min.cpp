...
int main(int argc, char* argv[])
{
    ...
    string path1 = argv[3];
    string min_chi   = "files_data/chi2_minumum_COMB.txt";
    string delta_chi = "files_data/chi2_s2t-dm2_surface_COMBINED.txt";
    ...
    int dmn= atoi(argv[2]);
    int cols, val;
    string db_dat_f = "files_data/chi2_s2t-dm2_surface_SPEC-noFL.txt";
    string rn_dat_f = "../RENO_SPEC/files/chi2_s2t-dm2_surface_spect-noFL.txt";
    ifstream db_data((path1 + db_dat_f).c_str());
    ifstream rn_data((path1 + rn_dat_f).c_str());
    string db_chi2M = "files_data/chi2_minumum_SPEC.txt";
    string rn_chi2M = "../RENO_SPEC/files/chi2_minimun_spect.txt";
    ...
    std::cout << rn_chi2min[0] << "\t" << rn_chi2min[1] << "\t" << rn_chi2min[2] << std::endl;
    ...
    cout << "For s2t =  " << comb_chi[val][0] << ",  dmn =  " << comb_chi[val][1] << endl;
    ...
    string s2t_file = "files_data/db_s2t_chi2_COMBINED.txt";
    string dmn_file = "files_data/db_dm2_chi2_COMBINED.txt";
